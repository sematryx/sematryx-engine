...
Typed variable descriptors are now accepted by the API; continuous descriptors execute immediately while integer/categorical descriptors are validated and deferred to upcoming Stage 3 solver slices.
